...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe(self):
        """Test creating a recipe with API endpoint"""
        payload = {
            "title": "Sample recipe",
            "time_minutes": 30,
            "price": Decimal("5.99"),
    ...
    def test_delete_other_users_recipe(self):
        ...
        new_user = create_user(email="ks146123@gmail.com", password="test1234")
    ...
    def test_update_recipe_assign_ingredient(self):
        """Test assigning an exisiing ingredient when updating arecipe"""
    ...
    def test_clear_reipe_ingredients(self):
        """Test clearin a recipes ingredients"""
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(
            user=self.user,
            title="Masala Biryani",
        )
        r2 = create_recipe(
            user=self.user,
            title="Paneer tikka",
        )
        in1 = Ingredient.objects.create(user=self.user, name="Masala")
